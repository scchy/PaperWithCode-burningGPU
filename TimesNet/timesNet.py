...
# Reference: https://github.com/thuml/Time-Series-Library/blob/main/models/TimesNet.py
# Func: Times Net
# ==========================================================================================
...
class Model(nn.Module):
    ...
    def imputation(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask):
        # Normalization from Non-stationart Trabsformer
        means = x_enc.mean(1, keepdim=True).detach()
        x_enc = x_enc - means
        stdev = torch.sqrt(
            torch.var(x_enc, dim=1, keepdim=True, unbiased=False) + 1e-5
    ...
    def classification(self, x_enc, x_mark_enc):
        ...
        # Output
        # the output transformer encoder/decoder embeddings dont include non-linearity
